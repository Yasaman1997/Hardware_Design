...
HD_PWD='C:/Users/iGreen/Desktop/DESIGN AUTOMATION/HW3/vivado/Q12/Q12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grades.vds -m64 -mode batch -messageDb vivado.pb -notrace -source grades.tcl
