...
HD_PWD='C:/Users/iGreen/Desktop/DESIGN AUTOMATION/HW3/vivado/Q9/Q9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frequency.vds -m64 -mode batch -messageDb vivado.pb -notrace -source frequency.tcl
