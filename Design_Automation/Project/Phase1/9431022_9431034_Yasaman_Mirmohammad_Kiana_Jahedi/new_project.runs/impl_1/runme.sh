...
HD_PWD='D:/Vivado_Projects/FPGA_Project/new_project/new_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SORTER.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SORTER.tcl -notrace
