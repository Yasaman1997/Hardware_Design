...
HD_PWD='D:/Vivado_Projects/FPGA_Project/new_project/new_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SORTER.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SORTER.tcl
